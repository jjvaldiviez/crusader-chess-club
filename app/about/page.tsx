...
export default function About() {
    return (
        <div className="flex min-h-screen items-center justify-center bg-zinc-50 font-sans dark:bg-black">
            <main className="flex min-h-screen w-full max-w-2xl flex-col items-center py-20 px-6 bg-white dark:bg-black">
                <header className="flex flex-col items-center mb-8">
                    <Image
                        ...
                        priority
                    />
                    <h1 className="mt-4 text-3xl font-bold text-black dark:text-zinc-50">
                        About Crusaders Chess Club
                    </h1>
                </header>
